...
regularize(regularization:Dict{String, Real}, k_1inv:Float64, k_1:Float64) \n
...
Here, lamda = 1, because our mean was derived from an experimental protein structure \n
Otherwise, lambda = ranking score (0-1) of protein structure prediction \n
...
function regularize(regularization, k_1inv, k_1)
    return Distributions.logpdf(Normal(regularization["mean"], regularization["std_dev"]), k_1inv - k_1)*regularization["lambda"]  
end